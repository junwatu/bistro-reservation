          ...
          <TableContainer>
            <Table variant="simple">
              <Thead>
                <Tr>
                  <Th>status</Th>
                  {hasAccess('bistro', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>bistro</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    <Td>{record.status}</Td>
                    {hasAccess('bistro', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/bistros/view/${record.bistro?.id}`}>
                          {record.bistro?.name}
                        </Link>
                      </Td>
                    )}
